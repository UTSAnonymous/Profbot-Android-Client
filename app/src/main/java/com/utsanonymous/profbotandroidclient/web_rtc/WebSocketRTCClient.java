...
package com.utsanonymous.profbotandroidclient.web_rtc;

import android.os.Handler;
import android.os.HandlerThread;
import android.util.Log;

import com.utsanonymous.profbotandroidclient.call.CallActivity;
import com.utsanonymous.profbotandroidclient.util.AsyncHttpURLConnection;
import com.utsanonymous.profbotandroidclient.util.AsyncHttpURLConnection.AsyncHttpEvents;
import com.utsanonymous.profbotandroidclient.web_rtc.RoomParametersFetcher.RoomParametersFetcherEvents;
...
public class WebSocketRTCClient implements AppRTCClient, WebSocketChannelClient.WebSocketChannelEvents {
    ...
    public WebSocketRTCClient(CallActivity events) {
        this.events = (SignalingEvents) events;
