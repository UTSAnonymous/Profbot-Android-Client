...
package com.utsanonymous.profbotandroidclient.call;
...
import com.utsanonymous.profbotandroidclient.PubNubMain;
import com.utsanonymous.profbotandroidclient.R;
import com.utsanonymous.profbotandroidclient.databinding.ActivityCallBinding;
import com.utsanonymous.profbotandroidclient.util.Constants;
import com.utsanonymous.profbotandroidclient.web_rtc.AppRTCAudioManager;
import com.utsanonymous.profbotandroidclient.web_rtc.AppRTCClient;
import com.utsanonymous.profbotandroidclient.web_rtc.AppRTCClient.RoomConnectionParameters;
import com.utsanonymous.profbotandroidclient.web_rtc.AppRTCClient.SignalingParameters;
import com.utsanonymous.profbotandroidclient.web_rtc.PeerConnectionClient;
import com.utsanonymous.profbotandroidclient.web_rtc.PeerConnectionClient.PeerConnectionParameters;
import com.utsanonymous.profbotandroidclient.web_rtc.WebSocketRTCClient;
...
import static com.utsanonymous.profbotandroidclient.util.Constants.CAPTURE_PERMISSION_REQUEST_CODE;
import static com.utsanonymous.profbotandroidclient.util.Constants.EXTRA_ROOMID;
import static com.utsanonymous.profbotandroidclient.util.Constants.LOCAL_HEIGHT_CONNECTED;
import static com.utsanonymous.profbotandroidclient.util.Constants.LOCAL_HEIGHT_CONNECTING;
import static com.utsanonymous.profbotandroidclient.util.Constants.LOCAL_WIDTH_CONNECTED;
import static com.utsanonymous.profbotandroidclient.util.Constants.LOCAL_WIDTH_CONNECTING;
import static com.utsanonymous.profbotandroidclient.util.Constants.LOCAL_X_CONNECTED;
import static com.utsanonymous.profbotandroidclient.util.Constants.LOCAL_X_CONNECTING;
import static com.utsanonymous.profbotandroidclient.util.Constants.LOCAL_Y_CONNECTED;
import static com.utsanonymous.profbotandroidclient.util.Constants.LOCAL_Y_CONNECTING;
import static com.utsanonymous.profbotandroidclient.util.Constants.REMOTE_HEIGHT;
import static com.utsanonymous.profbotandroidclient.util.Constants.REMOTE_WIDTH;
import static com.utsanonymous.profbotandroidclient.util.Constants.REMOTE_X;
import static com.utsanonymous.profbotandroidclient.util.Constants.REMOTE_Y;
import static com.utsanonymous.profbotandroidclient.util.Constants.STAT_CALLBACK_PERIOD;
...
public class CallActivity extends AppCompatActivity
    ...
    private void setupListeners() {
        ...
        binding.topButton.setOnTouchListener(new MyTouchListner(Constants.JSON_FORWARD));
        binding.downButton.setOnTouchListener(new MyTouchListner(Constants.JSON_BACKWARD));
        binding.leftButton.setOnTouchListener(new MyTouchListner(Constants.JSON_LEFT));
        binding.rightButton.setOnTouchListener(new MyTouchListner(Constants.JSON_RIGHT));
        binding.emergencyStop.setOnClickListener(view -> stopButton());
    }
    ...
    /**
     * Function below are for Pubnub control data streaming
     */
